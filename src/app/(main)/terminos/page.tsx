  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="prose prose-sm max-w-none space-y-4 text-[13px] text-[#1D1D1F]/80 leading-relaxed">
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">1. Aceptación</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">2. Productos</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">3. Precios y Pagos</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">4. Envíos</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">5. Garantía</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">6. Devoluciones</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">7. Cuenta de Usuario</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">8. Propiedad Intelectual</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">9. Ley Aplicable</h2>
          <p>
        ...
        <section>
          <h2 className="text-[16px] font-bold text-[#1D1D1F] mb-2">10. Contacto</h2>
          <p>

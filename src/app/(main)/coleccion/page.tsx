    ...
    <div className="space-y-8">
        ...
        return (
          <section key={cat} className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-[18px] lg:text-[22px] font-bold tracking-tight text-[#1D1D1F]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-5">
              {catProducts.map((p) => (
                <Link
                  ...
                  className="group rounded-3xl overflow-hidden bg-white border border-[#E5E5E7] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_12px_40px_-8px_rgb(0_0_0/0.12)] hover:border-[#D4AF37]/30 transition-all duration-300"
                >
      ...
      <section className="rounded-3xl bg-gradient-to-br from-[#1D1D1F] to-[#2A2A2D] p-6 lg:p-10 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 mt-4 rounded-full bg-[#D4AF37] px-6 py-2.5 text-[13px] font-semibold text-[#1D1D1F] tap-scale"
        >
          WhatsApp VIP
